...
export default function SignupForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Nickname:", nickname, "Email:", email, "Password:", password);
  };
    ...
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center font-terminal px-4">
      ...
      {step >= 1 && (
        <div className="mb-8 text-2xl">
          <TypewriterText text="SIGN UP" speed={100} onComplete={() => setStep(2)} />
        </div>
      )}
      ...
      <div className="w-full max-w-md">
        ...
        >
          {step >= 2 && (
            <>
              <TypewriterText text="NICKNAME" speed={100} onComplete={() => setStep(3)}/>
              <input
                type="text"
          ...
          {step >= 3 && (
            <>
              <TypewriterText text="EMAIL" speed={100} onComplete={() => setStep(4)}/>
              <input
                type="email"
                className="w-full mt-2 p-2 rounded bg-gray-800 text-white border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          {step >= 4 && (
            <>
              <TypewriterText text="PASSWORD" speed={100} onComplete={() => setStep(5)} />
              <input
                type="password"
                className="w-full mt-2 p-2 rounded bg-gray-800 text-white border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="••••••••"
          ...
          {step >= 5 && (
            ...
            >
              <TypewriterText text="SIGN UP" speed={100} />
            </button>
          )}
        </form>
